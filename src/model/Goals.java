...
public class Goals {
	...
	public int getUser_id5() {return user_id5;}
	public void setUser_id5(int user_id5) {this.user_id5 = user_id5;}
	...
	public double getRemaining_amount() {return remaining_amount;}
	public void setRemaining_amount(double remaining_amount) {this.remaining_amount = remaining_amount;
}
